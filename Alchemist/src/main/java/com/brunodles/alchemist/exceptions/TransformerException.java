...
public class TransformerException extends RuntimeException {
    ...
    public static TransformerException cantCreateTransformer(Class<? extends Transmutation> transformerClass,
            Exception cause) {
    ...
    public static TransformerException cantTransform(Object input, Class<? extends Transmutation> transformerClass,
            Exception cause) {
